        ...
        <SafeAreaView className="flex-1 bg-background">
            ...
            >
                ...
                <Text className="text-sm font-sans-medium text-muted-foreground">
                    Lumora helps you track recurring subscriptions and get renewal reminders. It
                    does not initiate, cancel, or modify charges on your behalf with any third-party
                    service — all subscription data is self-reported by you.
                </Text>
                ...
                <Text className="text-sm font-sans-medium text-muted-foreground">
                    ...
                    Manage or cancel it anytime from your device&apos;s subscription settings.
